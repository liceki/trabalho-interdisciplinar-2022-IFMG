...
public class InvoiceResgistrationDialog extends javax.swing.JDialog implements RegistrationDialog{

    private final SupplierController controller;
    private final TablePanel supplierTablePanel;
    
    public InvoiceResgistrationDialog(java.awt.Frame parent, boolean modal, TablePanel supplierTablePanel) {
        super(parent, modal);
        initComponents();

...
public class InvoiceTablePanel extends javax.swing.JPanel implements RelationalPanel, TablePanel{
    ...
    private void btnAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSupplierActionPerformed
        this.registrationDialog = new InvoiceResgistrationDialog(InvoiceMainPanel.parent, true, this);
